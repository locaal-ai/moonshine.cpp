...
std::vector<const char *> cached_decode_input_names = {
    ...
    "args_21", "args_22", "args_23", "args_24", "args_25", "args_26",
};

std::vector<const char *> cached_decode_output_names = {
    "reversible_embedding", "functional_23", "functional_23_1", "input_layer_102",
    "input_layer_103",      "functional_26", "functional_26_1", "input_layer_106",
    "input_layer_107",      "functional_29", "functional_29_1", "input_layer_110",
    "input_layer_111",      "functional_32", "functional_32_1", "input_layer_114",
    "input_layer_115",      "functional_35", "functional_35_1", "input_layer_118",
    "input_layer_119",      "functional_38", "functional_38_1", "input_layer_122",
    "input_layer_123",
};

std::vector<const char *> decode_input_names = {"args_0", "args_1", "args_2"};
std::vector<const char *> decode_output_names = {
    "reversible_embedding", "functional_22", "functional_22_1", "functional_22_2",
    "functional_22_3",      "functional_25", "functional_25_1", "functional_25_2",
    "functional_25_3",      "functional_28", "functional_28_1", "functional_28_2",
                                              ...
                                              size_t max_len)
{
    ...
    auto context =
        encode_->Run(Ort::RunOptions{nullptr}, encode_input_names.data(), encode_inputs.data(),
                     encode_inputs.size(), encode_ouput_names.data(), encode_ouput_names.size());
